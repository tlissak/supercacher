...
class BlockCartMod extends Module
{
    private $_html = '';
	...
	public function hookRightColumn($params)
	{
		...
		return $this->display(__FILE__, 'blockcartmod.tpl');
	}
	...
	public function hookAjaxCall($params)
	{
		global $smarty;
		$this->smartyAssigns($smarty, $params);
		return $this->display(__FILE__, 'blockcartmod-json.tpl');
	}
}
