...
<ul class="product-list">
	...
	<div class="p-20">
	<span class="btn"><span>
	<a href="{$product.link|escape:'htmlall':'UTF-8'}&amp;content_only=1" title="{l s='View'}" class="nyroModal"><img src="GUI/images/zoom.gif" alt="{l s='View'}" /></a></span></span>
	{if ($product.allow_oosp OR $product.quantity > 0) &&
	$product.customizable != 2} 
	<span class="btn right"><span><a class="ajax_add_to_cart_button" rel="ajax_id_product_{$product.id_product|intval}" href="{$base_dir}cart.php?add&amp;id_product={$product.id_product|intval}&amp;token={$static_token}"><img src="GUI/images/cart.gif" alt="{l s='Add to cart'}" class= /></a></span></span> {else} 
