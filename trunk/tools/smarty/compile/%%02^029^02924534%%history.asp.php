<?php /* Smarty version 2.6.20, created on 2010-06-13 15:04:12
         compiled from ../../../GUI/history.asp */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'l', '../../../GUI/history.asp', 2, false),array('function', 'dateFormat', '../../../GUI/history.asp', 58, false),array('function', 'displayPrice', '../../../GUI/history.asp', 60, false),array('modifier', 'intval', '../../../GUI/history.asp', 56, false),array('modifier', 'string_format', '../../../GUI/history.asp', 57, false),array('modifier', 'escape', '../../../GUI/history.asp', 63, false),)), $this); ?>
<?php ob_start(); ?>
...
?>
						<tr
							...
							<td class="history_link bold"><?php if ($this->_tpl_vars['order']['invoice'] && $this->_tpl_vars['order']['virtual']): ?><img
								src="<?php echo $this->_tpl_vars['img_dir']; ?>
icon/download_product.gif" class="icon"
								alt="<?php echo smartyTranslate(array('s' => 'Product(s) to download'), $this);?>
"
								title="<?php echo smartyTranslate(array('s' => 'Product(s) to download'), $this);?>
" /><?php endif; ?> <a
								class="color-myaccount"
								href="javascript:showOrder(1, <?php echo ((is_array($_tmp=$this->_tpl_vars['order']['id_order'])) ? $this->_run_mod_handler('intval', true, $_tmp) : intval($_tmp)); ?>
...
<?php echo ((is_array($_tmp=$this->_tpl_vars['order']['id_order'])) ? $this->_run_mod_handler('string_format', true, $_tmp, "%06d") : smarty_modifier_string_format($_tmp, "%06d")); ?>
							...
							<td class="history_invoice"><?php if (( $this->_tpl_vars['order']['invoice'] || $this->_tpl_vars['order']['invoice_number'] ) && $this->_tpl_vars['invoiceAllowed']): ?> <a
...
"><img
								src="<?php echo $this->_tpl_vars['img_dir']; ?>
icon/pdf.gif"
								alt="<?php echo smartyTranslate(array('s' => 'Invoice'), $this);?>
 <?php echo ((is_array($_tmp=$this->_tpl_vars['order']['name'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall', 'UTF-8') : smarty_modifier_escape($_tmp, 'htmlall', 'UTF-8')); ?>
"
								class="icon" /></a> <a
								href="<?php echo $this->_tpl_vars['base_dir']; ?>
