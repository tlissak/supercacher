<?php /* Smarty version 2.6.20, created on 2010-06-09 16:30:13
         compiled from D:%5CHTDOCS%5Cpresta-tpl/themes/debug.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'assign_debug_info', 'D:\\HTDOCS\\presta-tpl/themes/debug.tpl', 5, false),array('modifier', 'escape', 'D:\\HTDOCS\\presta-tpl/themes/debug.tpl', 12, false),array('modifier', 'string_format', 'D:\\HTDOCS\\presta-tpl/themes/debug.tpl', 12, false),array('modifier', 'debug_print_var', 'D:\\HTDOCS\\presta-tpl/themes/debug.tpl', 18, false),)), $this); ?>
...
?>
                <tr bgcolor=<?php if (!(1 & $this->_sections['config_vars']['index'])): ?>#eeeeee<?php else: ?>#fafafa<?php endif; ?>><td valign=top><font color=maroon>{#<?php echo $this->_tpl_vars['_debug_config_keys'][$this->_sections['config_vars']['index']]; ?>
...
$this->_sections['templates']['last']       = ($this->_sections['templates']['iteration'] == $this->_sections['templates']['total']);
?>
                _smarty_console.document.write("<tr bgcolor=<?php if (!(1 & $this->_sections['templates']['index'])): ?>#eeeeee<?php else: ?>#fafafa<?php endif; ?>><td colspan=2><?php unset($this->_sections['indent']);
$this->_sections['indent']['name'] = 'indent';
$this->_sections['indent']['loop'] = is_array($_loop=$this->_tpl_vars['_debug_tpls'][$this->_sections['templates']['index']]['depth']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
$this->_sections['indent']['show'] = true;
$this->_sections['indent']['max'] = $this->_sections['indent']['loop'];
...
$this->_sections['vars']['last']       = ($this->_sections['vars']['iteration'] == $this->_sections['vars']['total']);
?>
                _smarty_console.document.write("<tr bgcolor=<?php if (!(1 & $this->_sections['vars']['index'])): ?>#eeeeee<?php else: ?>#fafafa<?php endif; ?>><td valign=top><font onclick='document.getElementById(\"idx_<?php echo $this->_sections['vars']['index']; ?>
\").style.height=\"\";' color=blue><?php echo $this->_sections['vars']['index']; ?>
{$<?php echo $this->_tpl_vars['_debug_keys'][$this->_sections['vars']['index']]; ?>
}</font></td><td nowrap><div style='height:22px;overflow:hidden' id='idx_<?php echo $this->_sections['vars']['index']; ?>
'><font color=green><?php echo ((is_array($_tmp=smarty_modifier_debug_print_var($this->_tpl_vars['_debug_vals'][$this->_sections['vars']['index']]))) ? $this->_run_mod_handler('escape', true, $_tmp, 'javascript') : smarty_modifier_escape($_tmp, 'javascript')); ?>
</font></div></td></tr>");
        <?php endfor; else: ?>
...
$this->_sections['config_vars']['last']       = ($this->_sections['config_vars']['iteration'] == $this->_sections['config_vars']['total']);
?>
                _smarty_console.document.write("<tr bgcolor=<?php if (!(1 & $this->_sections['config_vars']['index'])): ?>#eeeeee<?php else: ?>#fafafa<?php endif; ?>><td valign=top><font color=maroon>{#<?php echo $this->_tpl_vars['_debug_config_keys'][$this->_sections['config_vars']['index']]; ?>
#}</font></td><td><font color=green><?php echo ((is_array($_tmp=smarty_modifier_debug_print_var($this->_tpl_vars['_debug_config_vals'][$this->_sections['config_vars']['index']]))) ? $this->_run_mod_handler('escape', true, $_tmp, 'javascript') : smarty_modifier_escape($_tmp, 'javascript')); ?>
</font></td></tr>");
        <?php endfor; else: ?>
