 ...
 * http://www.gnucitizen.org useage : $.include('/xyz.js') ;
...
jQuery.extend({	/*	 * hijack jQuery.ready	 */
	_ready: jQuery.ready,
	...
	ready: function () {		isReady = true;
		...
		if (isReady) { window.clearInterval(jQuery.includeTimer); jQuery._ready.apply(jQuery, arguments); }
	}
});
