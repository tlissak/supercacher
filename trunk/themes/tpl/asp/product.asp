...
{include file="$tpl_dir/inc-private/product_js.tpl"}
...
<!-- RIGHT -->
	...
	<!--{/if} -->
    <!--
	{include file="$tpl_dir/inc-private/product-thumb.tpl" }
    -->
...
<!-- LEFT -->
	...
	{include file="$tpl_dir/inc-private/product-add-to-cart.tpl" }
	<!-- #include file="inc-private/product-add-to-cart.tpl" -->
	<div class="spacer"></div>
	
	
	<!-- {if $confirmation}--><p class="confirmation">{$confirmation}</p><!--{/if} -->   
	{include file="$tpl_dir/inc-private/product-packcont.tpl" }
	<!-- #include file="inc-private/product-packcont.tpl" -->
	{include file="$tpl_dir/inc-private/product-color.tpl" }
	<!-- #include file="inc-private/product-color.tpl" -->
	{include file="$tpl_dir/inc-private/product-discount.tpl" }
	<!-- #include file="inc-private/product-discount.tpl" -->
	
	
	{include file="$tpl_dir/inc-private/product-desc.tpl" }	
	<!-- #include file="inc-private/product-desc.tpl" -->
	
	<div class="clear"></div>
	{include file="$tpl_dir/inc-private/product-custom.tpl" }
	<!-- #include file="inc-private/product-custom.tpl" -->
	{include file="$tpl_dir/inc-private/product-pack.tpl" }
	...
	<!--{if $HOOK_PRODUCT_ACTIONS}--> {$HOOK_PRODUCT_ACTIONS} <!--{/if}-->
		...
		{include file="$tpl_dir/inc-private/product-accessories.tpl" }	
