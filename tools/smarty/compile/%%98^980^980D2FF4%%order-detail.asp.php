<?php /* Smarty version 2.6.20, created on 2010-06-07 15:00:11
         compiled from ../../../GUI//order-detail.asp */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'l', '../../../GUI//order-detail.asp', 2, false),array('function', 'dateFormat', '../../../GUI//order-detail.asp', 2, false),array('function', 'displayWtPriceWithCurrency', '../../../GUI//order-detail.asp', 119, false),array('function', 'convertPriceWithCurrency', '../../../GUI//order-detail.asp', 177, false),array('function', 'counter', '../../../GUI//order-detail.asp', 203, false),array('modifier', 'escape', '../../../GUI//order-detail.asp', 19, false),array('modifier', 'string_format', '../../../GUI//order-detail.asp', 32, false),array('modifier', 'intval', '../../../GUI//order-detail.asp', 40, false),array('modifier', 'nl2br', '../../../GUI//order-detail.asp', 49, false),array('modifier', 'count', '../../../GUI//order-detail.asp', 306, false),)), $this); ?>
...
?>
		<tr
			class="<?php if (($this->_foreach['orderStates']['iteration'] <= 1)): ?>first_item<?php elseif (($this->_foreach['orderStates']['iteration'] == $this->_foreach['orderStates']['total'])): ?>last_item<?php endif; ?> <?php if (($this->_foreach['orderStates']['iteration']-1) % 2): ?>alternate_item<?php else: ?>item<?php endif; ?>">
...
<?php endif; ?> <?php if ($this->_tpl_vars['followup']): ?>
<p class="bold"><?php echo smartyTranslate(array('s' => 'Click the following link to track delivery of your
order'), $this);?>
</p>
...
<p class="bold"><?php echo smartyTranslate(array('s' => 'Carrier:'), $this);?>
...
<?php endif; ?> <?php if ($this->_tpl_vars['order']->recyclable): ?>
<p><img src="<?php echo $this->_tpl_vars['img_dir']; ?>
icon/recyclable.gif" alt="" class="icon" />&nbsp;<?php echo smartyTranslate(array('s' => 'You have given permission to receive your order in recycled
packaging.'), $this);?>
</p>
<?php endif; ?> <?php if ($this->_tpl_vars['order']->gift): ?>
<p><img src="<?php echo $this->_tpl_vars['img_dir']; ?>
...
<ul class="address item">
	...
	<?php if ($this->_tpl_vars['address_invoice']->company): ?>
	<li class="address_company"><?php echo ((is_array($_tmp=$this->_tpl_vars['address_invoice']->company)) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall', 'UTF-8') : smarty_modifier_escape($_tmp, 'htmlall', 'UTF-8')); ?>
</li>
	<?php endif; ?>
	...
	<?php if ($this->_tpl_vars['address_invoice']->address2): ?>
	<li class="address_address2"><?php echo ((is_array($_tmp=$this->_tpl_vars['address_invoice']->address2)) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall', 'UTF-8') : smarty_modifier_escape($_tmp, 'htmlall', 'UTF-8')); ?>
</li>
	<?php endif; ?>
...
<?php endif; ?></li>
	<?php if ($this->_tpl_vars['address_invoice']->phone): ?>
	<li class="address_phone"><?php echo ((is_array($_tmp=$this->_tpl_vars['address_invoice']->phone)) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall', 'UTF-8') : smarty_modifier_escape($_tmp, 'htmlall', 'UTF-8')); ?>
</li>
	<?php endif; ?> <?php if ($this->_tpl_vars['address_invoice']->phone_mobile): ?>
	<li class="address_phone_mobile"><?php echo ((is_array($_tmp=$this->_tpl_vars['address_invoice']->phone_mobile)) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall', 'UTF-8') : smarty_modifier_escape($_tmp, 'htmlall', 'UTF-8')); ?>
</li>
	<?php endif; ?>
</ul>
</div>
...
<ul class="address alternate_item">
	...
	<?php if ($this->_tpl_vars['address_delivery']->company): ?>
	<li class="address_company"><?php echo ((is_array($_tmp=$this->_tpl_vars['address_delivery']->company)) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall', 'UTF-8') : smarty_modifier_escape($_tmp, 'htmlall', 'UTF-8')); ?>
</li>
	<?php endif; ?>
	...
	<?php if ($this->_tpl_vars['address_delivery']->address2): ?>
	<li class="address_address2"><?php echo ((is_array($_tmp=$this->_tpl_vars['address_delivery']->address2)) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall', 'UTF-8') : smarty_modifier_escape($_tmp, 'htmlall', 'UTF-8')); ?>
</li>
	<?php endif; ?>
...
<?php endif; ?></li>
	<?php if ($this->_tpl_vars['address_delivery']->phone): ?>
	<li class="address_phone"><?php echo ((is_array($_tmp=$this->_tpl_vars['address_delivery']->phone)) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall', 'UTF-8') : smarty_modifier_escape($_tmp, 'htmlall', 'UTF-8')); ?>
</li>
	<?php endif; ?> <?php if ($this->_tpl_vars['address_delivery']->phone_mobile): ?>
	<li class="address_phone_mobile"><?php echo ((is_array($_tmp=$this->_tpl_vars['address_delivery']->phone_mobile)) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall', 'UTF-8') : smarty_modifier_escape($_tmp, 'htmlall', 'UTF-8')); ?>
</li>
	<?php endif; ?>
</ul>
</div>
...
<table class="std">
	...
	<tfoot>
		...
		<tr class="item">
			<td colspan="<?php if ($this->_tpl_vars['return_allowed']): ?>6<?php else: ?>5<?php endif; ?>"><?php echo smartyTranslate(array('s' => 'Total products
			(tax excl.):'), $this);?>
 ...
 <span class="price"><?php echo Product::displayWtPriceWithCurrency(array('price' => $this->_tpl_vars['order']->getTotalProductsWithTaxes(),'currency' => $this->_tpl_vars['currency'],'convert' => 0), $this);?>
		...
		<tr class="item">
			<td colspan="<?php if ($this->_tpl_vars['return_allowed']): ?>6<?php else: ?>5<?php endif; ?>"><?php echo smartyTranslate(array('s' => 'Total
			vouchers:'), $this);?>
 <span class="price-discount"><?php echo Product::displayWtPriceWithCurrency(array('price' => $this->_tpl_vars['order']->total_discounts,'currency' => $this->_tpl_vars['currency'],'convert' => 1), $this);?>
		...
		<?php endif; ?> <?php if ($this->_tpl_vars['order']->total_wrapping > 0): ?>
		<tr class="item">
			<td colspan="<?php if ($this->_tpl_vars['return_allowed']): ?>6<?php else: ?>5<?php endif; ?>"><?php echo smartyTranslate(array('s' => 'Total
			gift-wrapping:'), $this);?>
 <span class="price-wrapping"><?php echo Product::displayWtPriceWithCurrency(array('price' => $this->_tpl_vars['order']->total_wrapping,'currency' => $this->_tpl_vars['currency'],'convert' => 0), $this);?>
		...
		<?php endif; ?>
		<tr class="item">
			<td colspan="<?php if ($this->_tpl_vars['return_allowed']): ?>6<?php else: ?>5<?php endif; ?>"><?php echo smartyTranslate(array('s' => 'Total shipping
			(tax incl.):'), $this);?>
 <span class="price-shipping"><?php echo Product::displayWtPriceWithCurrency(array('price' => $this->_tpl_vars['order']->total_shipping,'currency' => $this->_tpl_vars['currency'],'convert' => 0), $this);?>
		...
		<tr class="item">
			<td colspan="<?php if ($this->_tpl_vars['return_allowed']): ?>6<?php else: ?>5<?php endif; ?>"><?php echo smartyTranslate(array('s' => 'Total:'), $this);?>
 <span
				class="price"><?php echo Product::displayWtPriceWithCurrency(array('price' => $this->_tpl_vars['order']->total_paid,'currency' => $this->_tpl_vars['currency'],'convert' => 0), $this);?>
</span></td>
		</tr>
	</tfoot>
	<tbody>
...
?> <?php if (! $this->_tpl_vars['product']['deleted']): ?> <?php $this->assign('productId', $this->_tpl_vars['product']['product_id']); ?>
...
<?php else: ?>--<?php endif; ?></label></td>
			<td class="bold"><label for="cb_<?php echo ((is_array($_tmp=$this->_tpl_vars['product']['id_order_detail'])) ? $this->_run_mod_handler('intval', true, $_tmp) : intval($_tmp)); ?>
"><?php echo ((is_array($_tmp=$this->_tpl_vars['product']['product_name'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall', 'UTF-8') : smarty_modifier_escape($_tmp, 'htmlall', 'UTF-8')); ?>
			...
			<td><input class="order_qte_input"
				name="order_qte_input[<?php echo ($this->_foreach['products']['iteration']-1); ?>
]" type="text"
				size="2" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['customizationQuantityTotal'])) ? $this->_run_mod_handler('intval', true, $_tmp) : intval($_tmp)); ?>
" /><label
				for="cb_<?php echo ((is_array($_tmp=$this->_tpl_vars['product']['id_order_detail'])) ? $this->_run_mod_handler('intval', true, $_tmp) : intval($_tmp)); ?>
"><span
				class="order_qte_span editable"><?php echo ((is_array($_tmp=$this->_tpl_vars['product']['customizationQuantityTotal'])) ? $this->_run_mod_handler('intval', true, $_tmp) : intval($_tmp)); ?>
</span></label></td>
			<td><label for="cb_<?php echo ((is_array($_tmp=$this->_tpl_vars['product']['id_order_detail'])) ? $this->_run_mod_handler('intval', true, $_tmp) : intval($_tmp)); ?>
...
?>
		<tr class="alternate_item">
			<?php if ($this->_tpl_vars['return_allowed']): ?>
			<td class="order_cb"><input type="checkbox"
				id="cb_<?php echo ((is_array($_tmp=$this->_tpl_vars['product']['id_order_detail'])) ? $this->_run_mod_handler('intval', true, $_tmp) : intval($_tmp)); ?>
"
...
" /></td>
			<?php endif; ?>
			<td colspan="2"><?php $_from = $this->_tpl_vars['customization']['datas']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
...
<?php echo smartyTranslate(array('s' => ':'), $this);?>
 <?php echo $this->_tpl_vars['data']['value']; ?>
			...
			<td><input class="order_qte_input"
				name="customization_qty_input[<?php echo ((is_array($_tmp=$this->_tpl_vars['customizationId'])) ? $this->_run_mod_handler('intval', true, $_tmp) : intval($_tmp)); ?>
]"
...
" /><label
				for="cb_<?php echo ((is_array($_tmp=$this->_tpl_vars['product']['id_order_detail'])) ? $this->_run_mod_handler('intval', true, $_tmp) : intval($_tmp)); ?>
"><span
				class="order_qte_span editable"><?php echo ((is_array($_tmp=$this->_tpl_vars['customization']['quantity'])) ? $this->_run_mod_handler('intval', true, $_tmp) : intval($_tmp)); ?>
</span></label>
			</td>
			<td colspan="2"></td>
		</tr>
...
<?php else: ?>--<?php endif; ?></label></td>
			<td class="bold"><label for="cb_<?php echo ((is_array($_tmp=$this->_tpl_vars['product']['id_order_detail'])) ? $this->_run_mod_handler('intval', true, $_tmp) : intval($_tmp)); ?>
">
			<?php if ($this->_tpl_vars['product']['download_hash'] && $this->_tpl_vars['invoice']): ?> <a
				href="<?php echo $this->_tpl_vars['base_dir']; ?>
...
icon/download_product.gif" class="icon"
				alt="<?php echo smartyTranslate(array('s' => 'Download product'), $this);?>
" /> </a> <a
				href="<?php echo $this->_tpl_vars['base_dir']; ?>
get-file.php?key=<?php echo ((is_array($_tmp=$this->_tpl_vars['product']['filename'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall', 'UTF-8') : smarty_modifier_escape($_tmp, 'htmlall', 'UTF-8')); ?>
-<?php echo ((is_array($_tmp=$this->_tpl_vars['product']['download_hash'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall', 'UTF-8') : smarty_modifier_escape($_tmp, 'htmlall', 'UTF-8')); ?>
...
">
 ...
 <?php endif; ?> </label></td>
			<td><input class="order_qte_input"
				name="order_qte_input[<?php echo ((is_array($_tmp=$this->_tpl_vars['product']['id_order_detail'])) ? $this->_run_mod_handler('intval', true, $_tmp) : intval($_tmp)); ?>
]"
...
" /><label
				for="cb_<?php echo ((is_array($_tmp=$this->_tpl_vars['product']['id_order_detail'])) ? $this->_run_mod_handler('intval', true, $_tmp) : intval($_tmp)); ?>
"><span
				class="order_qte_span editable"><?php echo ((is_array($_tmp=$this->_tpl_vars['productQuantity'])) ? $this->_run_mod_handler('intval', true, $_tmp) : intval($_tmp)); ?>
</span></label></td>
			<td><label for="cb_<?php echo ((is_array($_tmp=$this->_tpl_vars['product']['id_order_detail'])) ? $this->_run_mod_handler('intval', true, $_tmp) : intval($_tmp)); ?>
"><?php echo Product::convertPriceWithCurrency(array('price' => $this->_tpl_vars['product']['product_price_wt'],'currency' => $this->_tpl_vars['currency'],'convert' => 0), $this);?>
</label></td>
...
"><?php echo Product::convertPriceWithCurrency(array('price' => $this->_tpl_vars['product']['total_wt'],'currency' => $this->_tpl_vars['currency'],'convert' => 0), $this);?>
		...
		<?php endif; ?> <?php endif; ?> <?php endforeach; endif; unset($_from); ?> <?php $_from = $this->_tpl_vars['discounts']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
...
<?php if ($this->_tpl_vars['return_allowed']): ?> <br />
<p class="bold"><?php echo smartyTranslate(array('s' => 'Merchandise return'), $this);?>
</p>
<p><?php echo smartyTranslate(array('s' => 'If you want to return one or several products, please mark the
corresponding checkbox(es) and provide an explanation for the return.
Then click the button below.'), $this);?>
</p>
<p class="textarea"><textarea cols="67" rows="3" name="returnText"></textarea>
</p>
<p class="submit"><input type="submit" value="<?php echo smartyTranslate(array('s' => 'Make a RMA slip'), $this);?>
"
	name="submitReturnMerchandise" class="button_large" /> <input
	type="hidden" class="hidden" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['order']->id)) ? $this->_run_mod_handler('intval', true, $_tmp) : intval($_tmp)); ?>
"
	name="id_order" /></p>
<br />
<?php endif; ?></form>
...
?>
		<tr
			class="<?php if (($this->_foreach['messageList']['iteration'] <= 1)): ?>first_item<?php elseif (($this->_foreach['messageList']['iteration'] == $this->_foreach['messageList']['total'])): ?>last_item<?php endif; ?> <?php if (($this->_foreach['messageList']['iteration']-1) % 2): ?>alternate_item<?php else: ?>item<?php endif; ?>">
			<td><?php if ($this->_tpl_vars['message']['ename']): ?>
 ...
 <?php elseif ($this->_tpl_vars['message']['clastname']): ?> <?php echo ((is_array($_tmp=$this->_tpl_vars['message']['cfirstname'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall', 'UTF-8') : smarty_modifier_escape($_tmp, 'htmlall', 'UTF-8')); ?>
 ...
 <?php else: ?> <b><?php echo ((is_array($_tmp=$this->_tpl_vars['shop_name'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall', 'UTF-8') : smarty_modifier_escape($_tmp, 'htmlall', 'UTF-8')); ?>
</b>
			<?php endif; ?> <br />
...
<?php endif; ?> <?php if (isset ( $this->_tpl_vars['errors'] ) && $this->_tpl_vars['errors']): ?>
<div class="error">
...
<?php endif; ?>
<?php echo count($this->_tpl_vars['errors']); ?>
...
order-detail.php" method="post" class="std"
	id="sendOrderMessage">
<p class="bold"><?php echo smartyTranslate(array('s' => 'Add a message:'), $this);?>
</p>
<p><?php echo smartyTranslate(array('s' => 'If you want to leave us comment about your order, please write
it below.'), $this);?>
</p>
<p class="textarea"><textarea cols="67" rows="3" name="msgText"></textarea>
</p>
<p class="submit"><input type="hidden" name="id_order"
	value="<?php echo ((is_array($_tmp=$this->_tpl_vars['order']->id)) ? $this->_run_mod_handler('intval', true, $_tmp) : intval($_tmp)); ?>
" /> <input type="submit" class="button"
	name="submitMessage" value="<?php echo smartyTranslate(array('s' => 'Send'), $this);?>
" /></p>
</form>