<?php /* Smarty version 2.6.20, created on 2010-06-27 21:28:03
         compiled from ../../../GUI//modules/productcomments/productcomments.asp */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', '../../../GUI//modules/productcomments/productcomments.asp', 4, false),array('modifier', 'round', '../../../GUI//modules/productcomments/productcomments.asp', 9, false),array('modifier', 'escape', '../../../GUI//modules/productcomments/productcomments.asp', 15, false),array('modifier', 'truncate', '../../../GUI//modules/productcomments/productcomments.asp', 39, false),array('modifier', 'nl2br', '../../../GUI//modules/productcomments/productcomments.asp', 42, false),array('modifier', 'intval', '../../../GUI//modules/productcomments/productcomments.asp', 70, false),array('function', 'l', '../../../GUI//modules/productcomments/productcomments.asp', 5, false),array('function', 'dateFormat', '../../../GUI//modules/productcomments/productcomments.asp', 38, false),)), $this); ?>
...
?>
				<input disabled="disabled" type="radio" name="average" <?php if (((is_array($_tmp=$this->_tpl_vars['averageTotal'])) ? $this->_run_mod_handler('round', true, $_tmp) : round($_tmp)) != 0 && $this->_sections['average']['index'] == ((is_array($_tmp=$this->_tpl_vars['averageTotal'])) ? $this->_run_mod_handler('round', true, $_tmp) : round($_tmp))): ?>checked="checked"<?php endif; ?> />
			<?php endfor; endif; ?>
		</div>
...
$this->_sections['average']['last']       = ($this->_sections['average']['iteration'] == $this->_sections['average']['total']);
?>
				<input disabled="disabled" type="radio" name="<?php echo ((is_array($_tmp=$this->_tpl_vars['c']['name'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html', 'UTF-8') : smarty_modifier_escape($_tmp, 'html', 'UTF-8')); ?>
...
<input type="button" id="addCommentButton" value="<?php echo smartyTranslate(array('s' => 'Add a comment','mod' => 'productcomments'), $this);?>
" onclick="$('#sendComment').slideDown('slow');$(this).slideUp('slow');" />
</span></span>
<div class="clear"></div>
...
" method="post" class="std" id="sendComment" style="display:none;">
	<div >
		...
		<a href="javascript:closeCommentForm()">X</a> | <?php echo smartyTranslate(array('s' => 'Add a comment','mod' => 'productcomments'), $this);?>
...
_grade" value="5" />
		...
		<p><textarea cols="50" class="ipt"  rows="5" name="content" id="content"></textarea></p>
			...
			<span class="btn"><span><input class="button" name="submitMessage" value="<?php echo smartyTranslate(array('s' => 'Send','mod' => 'productcomments'), $this);?>
