<?php /* Smarty version 2.6.20, created on 2010-06-09 15:15:17
         compiled from D:%5CHTDOCS%5Cpresta-tpl/themes/ipnotik/product.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'D:\\HTDOCS\\presta-tpl/themes/ipnotik/product.tpl', 2, false),array('modifier', 'html_entity_decode', 'D:\\HTDOCS\\presta-tpl/themes/ipnotik/product.tpl', 9, false),array('modifier', 'floatval', 'D:\\HTDOCS\\presta-tpl/themes/ipnotik/product.tpl', 10, false),array('modifier', 'intval', 'D:\\HTDOCS\\presta-tpl/themes/ipnotik/product.tpl', 11, false),array('modifier', 'escape', 'D:\\HTDOCS\\presta-tpl/themes/ipnotik/product.tpl', 24, false),array('modifier', 'default', 'D:\\HTDOCS\\presta-tpl/themes/ipnotik/product.tpl', 26, false),array('modifier', 'date_format', 'D:\\HTDOCS\\presta-tpl/themes/ipnotik/product.tpl', 32, false),array('modifier', 'cat', 'D:\\HTDOCS\\presta-tpl/themes/ipnotik/product.tpl', 42, false),array('modifier', 'addslashes', 'D:\\HTDOCS\\presta-tpl/themes/ipnotik/product.tpl', 59, false),array('modifier', 'htmlspecialchars', 'D:\\HTDOCS\\presta-tpl/themes/ipnotik/product.tpl', 216, false),array('modifier', 'truncate', 'D:\\HTDOCS\\presta-tpl/themes/ipnotik/product.tpl', 294, false),array('modifier', 'stripslashes', 'D:\\HTDOCS\\presta-tpl/themes/ipnotik/product.tpl', 351, false),array('function', 'l', 'D:\\HTDOCS\\presta-tpl/themes/ipnotik/product.tpl', 49, false),array('function', 'convertPrice', 'D:\\HTDOCS\\presta-tpl/themes/ipnotik/product.tpl', 120, false),array('function', 'math', 'D:\\HTDOCS\\presta-tpl/themes/ipnotik/product.tpl', 212, false),array('function', 'displayWtPrice', 'D:\\HTDOCS\\presta-tpl/themes/ipnotik/product.tpl', 300, false),array('function', 'counter', 'D:\\HTDOCS\\presta-tpl/themes/ipnotik/product.tpl', 330, false),)), $this); ?>
...
<script type="text/javascript" src="./modules/categoriesbar/chrome.js"></script>
...
<div id="primary_block">
	...
	<h2><?php echo ((is_array($_tmp=$this->_tpl_vars['product']->name)) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall', 'UTF-8') : smarty_modifier_escape($_tmp, 'htmlall', 'UTF-8')); ?>
		...
		<div id="short_description_block">
			...
			<p id="button_more_detail"><a href="javascript:{}" class="button"><?php echo smartyTranslate(array('s' => 'More details'), $this);?>
</a></p>
			<?php endif; ?>
		</div>
		<?php endif; ?>
...
<?php else: ?>1<?php endif; ?>" size="2" maxlength="3" />
			...
			<span<?php if (! $this->_tpl_vars['allow_oosp'] && $this->_tpl_vars['product']->quantity == 0): ?> style="display:none;"<?php endif; ?> id="add_to_cart" class="buttons_bottom_block">
...
<?php endif; ?>
	...
	<div id="pb-right-column">
		...
		<ul id="usefull_link_block">
		  <span id="view_full_size" class="usefull_link_block_zoom"></span>
		  <span id="usefull_link_block_send"><?php if ($this->_tpl_vars['HOOK_EXTRA_LEFT']): ?><?php echo $this->_tpl_vars['HOOK_EXTRA_LEFT']; ?>
<?php endif; ?></span> 
		  <span id="usefull_link_block_print"><a href="javascript:print();">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></span>
		</ul>
		<div id="image-block">
		<!-- product img-->
		<div class="usefull_link_block_zoom">		
...
<div class="clear">
	<ul id="more_info_tabs" class="idTabs idTabsShort">
		<?php if ($this->_tpl_vars['product']->description): ?><li><a id="more_info_tab_more_info" href="#idTab1"><?php echo smartyTranslate(array('s' => 'Description'), $this);?>
</a></li><?php endif; ?>
...
"><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['accessory']['name'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 30) : smarty_modifier_truncate($_tmp, 30)))) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall', 'UTF-8') : smarty_modifier_escape($_tmp, 'htmlall', 'UTF-8')); ?>
</a>
				</h5>
				<p>
				 <a href="<?php echo ((is_array($_tmp=$this->_tpl_vars['accessoryLink'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall', 'UTF-8') : smarty_modifier_escape($_tmp, 'htmlall', 'UTF-8')); ?>
...
" /></a>
				...
				<p class="pprice"><?php echo Product::displayWtPrice(array('p' => $this->_tpl_vars['accessory']['price']), $this);?>
</p>
				  <a href="<?php echo ((is_array($_tmp=$this->_tpl_vars['accessoryLink'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall', 'UTF-8') : smarty_modifier_escape($_tmp, 'htmlall', 'UTF-8')); ?>
...
" class="ajax_add_to_cart_button"><?php echo smartyTranslate(array('s' => 'cart'), $this);?>
</a>
				</p>
			 </li>
		    <?php endforeach; endif; unset($_from); ?>
