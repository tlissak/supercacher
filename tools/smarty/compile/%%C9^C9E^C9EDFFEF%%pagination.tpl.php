<?php /* Smarty version 2.6.20, created on 2010-06-27 18:17:19
         compiled from ../../../GUI//inc-private/pagination.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'intval', '../../../GUI//inc-private/pagination.tpl', 1, false),array('modifier', 'escape', '../../../GUI//inc-private/pagination.tpl', 31, false),array('function', 'l', '../../../GUI//inc-private/pagination.tpl', 20, false),)), $this); ?>
<?php if (isset ( $this->_tpl_vars['p'] ) && $this->_tpl_vars['p']): ?> <?php if (((is_array($_tmp=$_GET['id_category'])) ? $this->_run_mod_handler('intval', true, $_tmp) : intval($_tmp))): ?> <?php $this->assign('requestPage', $this->_tpl_vars['link']->getPaginationLink('category',$this->_tpl_vars['category'],false,false,true,false)); ?> 
...
<ul class="pagination">
	<?php if ($this->_tpl_vars['p'] != 1): ?> <?php $this->assign('p_previous', $this->_tpl_vars['p']-1); ?>
...
">&laquo;&nbsp;
	...
	<?php else: ?>
		<li id="pagination_previous" class="disabled"><span>&laquo;&nbsp;
    	<?php echo smartyTranslate(array('s' => 'Previous'), $this);?>
</span></li>
	<?php endif; ?> 
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['pages_nb'])) ? $this->_run_mod_handler('intval', true, $_tmp) : intval($_tmp)); ?>
	...
	<?php endif; ?> 
    <?php if ($this->_tpl_vars['pages_nb'] > 1 && $this->_tpl_vars['p'] != $this->_tpl_vars['pages_nb']): ?> <?php $this->assign('p_next', $this->_tpl_vars['p']+1); ?>
...
<p><?php if (isset ( $this->_tpl_vars['query'] ) && $this->_tpl_vars['query']): ?><input type="hidden" name="search_query" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['query'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall', 'UTF-8') : smarty_modifier_escape($_tmp, 'htmlall', 'UTF-8')); ?>
" /><?php endif; ?> 
...
<?php if (is_array ( $this->_tpl_vars['requestNb'] )): ?> <?php $_from = $this->_tpl_vars['requestNb']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
